...
class Buttons extends React.Component {
  ...
  render() {
    ...
    if (this.state.useful) {
      styleUseful = 'tag-filled';
    }
    if (this.state.funny) {
      styleFunny = 'tag-filled';
    }
    if (this.state.cool) {
      styleCool = 'tag-filled';
    }
    return (
      <div>
...
const Useful = (props) => {
  return (
    <button className={props.styleUseful} onClick={props.onClick}>
      <span>
...
const Funny = (props) => {
  return (
    <button className={props.styleFunny} onClick={props.onClick}>
      <span>
        <svg viewBox="0 0 24 24" width="24px" height="24px">  
...
const Cool = (props) => {
  return (
    <button className={props.styleCool} onClick={props.onClick}>
      <span>
        <svg viewBox="0 0 24 24" width="24px" height="24px">  
